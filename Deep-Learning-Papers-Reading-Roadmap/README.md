...
PDF files live under `pdfs/` with shortened folder and file names (Windows path-length safe). Section numbers from this README are preserved in filenames (e.g. `04 - 2012 - ImageNet Classification with CNNs - Krizhevsky et al.pdf`).

| README section | Folder |
|----------------|--------|
| 1 Deep Learning History and Basics | `pdfs/1 History/` |
| 1.2 Deep Belief Network | `pdfs/1 History/1.2 DBN/` |
| 1.3 ImageNet Evolution | `pdfs/1 History/1.3 ImageNet/` |
| 1.4 Speech Recognition Evolution | `pdfs/1 History/1.4 Speech/` |
| 2 Deep Learning Method | `pdfs/2 Methods/` |
| 2.3 Unsupervised / Generative | `pdfs/2 Methods/2.3 Generative Models/` |
| 2.4 RNN / Seq2Seq | `pdfs/2 Methods/2.4 Seq2Seq/` |
| 2.5 Neural Turing Machine | `pdfs/2 Methods/2.5 NTM/` |
| 2.6 Deep RL | `pdfs/2 Methods/2.6 RL/` |
| 2.7 Transfer Learning | `pdfs/2 Methods/2.7 Transfer Learning/` |
| 2.8 One-Shot Learning | `pdfs/2 Methods/2.8 One-Shot/` |
